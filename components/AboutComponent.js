...
function History() {
    ...
    return (
        <Card title='Our History'>
            <Text style={styles.paragraph}>Started in 2010, Ristorante con Fusion quickly established 
                ...
                Hong Kong.  Featuring four of the best three-star Michelin chefs in 
                the world, you never know what will arrive on your plate the next 
                time you visit us.
            </Text>
            <Text style={styles.paragraph}>The restaurant traces its humble beginnings to The Frying Pan, 
